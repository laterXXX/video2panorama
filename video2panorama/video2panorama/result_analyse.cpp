...
//
//	string file_path = "d:/imgsource/panorama/907shift_kalman.txt";
...
//			stitching(preMat, matSrc, phase_correlate_shift, "d:/imgsource/panorama/906_fusion.jpg");
//			cout << endl;
//			cout << endl;
//			cout << endl;
//			swap(preMat, matSrc);
...
//
//	if (!shift_mat.empty()) {
//		imwrite("d:/imgsource/panorama/911_phase_correlate_kalman.jpg", shift_mat);
//	}
//	clock_t end = clock();
